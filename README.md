...
# Public variables
The code starts with assigning the name and abbreviation of the token using a string variable. The  name is token name is  'conquest' and abbreviation as 'con'
# Mapping variable
...
contract MyToken {
    ...
    string public tokenName = "conquest";
    string public tokenAbbrv = "con";
